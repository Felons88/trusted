-- Fix security definitions for payment tracking functions
-- Add SECURITY DEFINER to bypass RLS issues

-- Drop and recreate record_payment_attempt with SECURITY DEFINER
...
-- Also fix record_payment_details function
DROP FUNCTION IF EXISTS public.record_payment_details;
