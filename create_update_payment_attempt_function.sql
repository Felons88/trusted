-- Create RPC function to update payment attempt details
-- This bypasses RLS issues by using a secure function

CREATE OR REPLACE FUNCTION update_payment_attempt_details(
...
GRANT EXECUTE ON FUNCTION update_payment_attempt_details TO authenticated;
